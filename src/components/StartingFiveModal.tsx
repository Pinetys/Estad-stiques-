...
import { getSuggestedStarterIds } from '../utils/teamStorage';
import { Users, Check, AlertCircle, X, RotateCcw, CheckCircle2, Shield, Sparkles } from 'lucide-react';
...
export const StartingFiveModal: React.FC<StartingFiveModalProps> = ({
  ...
  const handleSuggestStarters = () => {
    playSound('score', soundEnabled);
    triggerHaptic('basket', vibrationEnabled);
    const suggested = getSuggestedStarterIds(players);
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1 text-[11px] font-mono">
              <button
                ...
                className="px-2 py-1 bg-orange-600/30 hover:bg-orange-600/50 text-orange-200 rounded border border-orange-500/50 transition flex items-center gap-1 shadow-xs active:scale-95"
                title="Sugerir automáticamente un quinteto inicial equilibrado por posiciones"
              >
